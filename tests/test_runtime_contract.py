...
def _make_valid_payload() -> dict:
    """Return a payload dict that conforms to the vendored contract schema."""
...
class TestSchemaPathResolution:
    ...
    def test_default_path_is_rootfs_location(
        self,
    ):
...
class TestLoadRuntimeSchema:
    ...
    def test_loads_valid_schema_file(
        self,
        tmp_path,
    ):
    ...
    def test_missing_file_raises_file_not_found(
        ...
        with pytest.raises(
            FileNotFoundError,
            match="Runtime schema not found",
        ):
...
class TestInitializeRuntimeSchema:
    ...
    def test_returns_schema_dict_on_success(
        self,
        tmp_path,
    ):
    ...
    def test_missing_schema_exits_nonzero(
        self,
        tmp_path,
    ):
    ...
    def test_unreadable_schema_exits_nonzero(
        self,
        tmp_path,
    ):
...
class TestValidateBeforePublish:
    ...
    def test_valid_payload_does_not_exit(
        self,
    ):
    ...
    def test_invalid_payload_exits_nonzero(
        self,
    ):
    ...
    def test_always_validates_regardless_of_env(
        self,
        tmp_path,
    ):
