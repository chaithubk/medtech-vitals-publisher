...
class TestCalculateSirs:
    ...
    def test_boundary_temperature_exactly_38(
        self,
    ):
    ...
    def test_boundary_hr_exactly_90(
        self,
    ):
...
class TestCalculateQsofa:
    ...
    def test_no_criteria_met(
        ...
        score = calculate_qsofa(
            respiratory_rate=16.0,
            bp_sys=120.0,
        )
        assert score == 0

    def test_rr_criterion(
        self,
    ):
    ...
    def test_altered_mentation_criterion(
        self,
    ):
    ...
    def test_rr_boundary_exactly_22(
        self,
    ):
    ...
    def test_bp_boundary_exactly_101(
        self,
    ):
...
class TestClassifySepsisStage:
    ...
    def test_septic_shock_high_lactate(
        self,
    ):
    ...
    def test_boundary_lactate_exactly_2(
        self,
    ):
...
class TestVitalsPayloadV2:
    ...
    def test_to_dict_sepsis_onset_ts_can_be_none(
        self,
    ):
...
class TestBuildPayload:
    ...
    def test_healthy_payload_scores(
        self,
    ):
    ...
    def test_sepsis_payload_scores(
        self,
    ):
    ...
    def test_altered_mentation_flag(
        self,
    ):
