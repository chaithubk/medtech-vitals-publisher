...
def _make_synthea_dir_with_conditions(
    obs_rows=None,
    cond_rows=None,
    ...
    _write_observations_csv(
        Path(tmpdir.name) / "observations.csv",
        obs_rows,
    )
    if cond_rows is not None:
        _write_conditions_csv(
            Path(tmpdir.name) / "conditions.csv",
            cond_rows,
        )
    return tmpdir
...
class TestSyntheaBridgeConstruction:
    ...
    def test_missing_observations_csv_raises(
        self,
    ):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with pytest.raises(
                FileNotFoundError,
                match="observations.csv",
            ):
                SyntheaBridge(tmpdir)

    def test_valid_dir_constructs(
        self,
    ):
...
class TestListPatients:
    ...
    def test_list_sepsis_patients_excludes_healthy(
        self,
    ):
...
class TestLoadPatient:
    ...
    def test_load_known_patient_returns_readings(
        self,
    ):
    ...
    def test_load_unknown_patient_returns_empty(
        self,
    ):
    ...
    def test_reading_contains_required_fields(
        self,
    ):
    ...
    def test_synthea_values_appear_in_reading(
        self,
    ):
    ...
    def test_fallback_fills_missing_vitals(
        self,
    ):
...
class TestIterPatient:
    ...
    def test_iter_patient_yields_dicts(
        self,
    ):
    ...
    def test_iter_patient_loop_false_finite(
        self,
    ):
        """iter_patient(loop=False) yields each reading exactly once."""
        with _make_synthea_dir() as tmpdir:
            bridge = SyntheaBridge(tmpdir)
            readings_non_loop = list(
                bridge.iter_patient(
                    "patient-A",
                    loop=False,
                )
    ...
    def test_iter_patient_unknown_yields_nothing(
        self,
    ):
    ...
    def test_iter_patient_timestamps_monotonic_on_loop(
        self,
    ):
...
class TestParseDateToMs:
    ...
    def test_datetime_is_ms_not_seconds(
        self,
    ):
...
class TestConditionsCSV:
    ...
    def test_list_sepsis_patients_from_conditions_finds_patient(
        self,
    ):
    ...
    def test_list_sepsis_patients_from_conditions_no_file(
        self,
    ):
    ...
    def test_list_sepsis_patients_merges_conditions(
        self,
    ):
        ...
        with _make_synthea_dir_with_conditions(
            obs_rows=healthy_obs,
            cond_rows=self._SEPSIS_ROWS,
        ) as tmpdir:
            bridge = SyntheaBridge(tmpdir)
    ...
    def test_get_sepsis_onset_ts_returns_ms(
        self,
    ):
    ...
    def test_get_sepsis_onset_ts_unknown_patient_returns_none(
        self,
    ):
    ...
    def test_get_sepsis_onset_ts_no_file_returns_none(
        self,
    ):
...
class TestIterPatientEngineFallback:
    ...
    def test_iter_patient_no_loinc_obs_loop_true_yields(
        self,
    ):
    ...
    def test_iter_patient_no_loinc_obs_loop_false_yields_nothing(
        self,
    ):
    ...
    def test_iter_patient_no_loinc_no_engine_loop_true_yields_nothing(
        self,
    ):
